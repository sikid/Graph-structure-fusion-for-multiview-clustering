...
% dataset = load('Number123456.mat');
% dataset = load('Number_v1245.mat');
% dataset = load('MSRCV.mat');%k1 =107 k2 = 9 gamma1 = gamma2 = 1
% dataset = load('yale3view.mat');%K1 = 12 K2 = 6
% dataset = load('yale3view_ZCQ.mat');
% dataset = load('sence_o.mat');
% dataset = load('number13.mat');
% dataset = load('number23.mat');
% dataset = load('number34.mat');
% dataset = load('number25.mat');
% dataset = load('number234.mat');

% dataset = load('C101_p1474.mat');%k1 = 91 k2 = 9 gamma1 = gamma2 =1  UTS = 91/11
% dataset = load('NH_p4660.mat');% K1 = 75 K2 = 115 gamma1 = 1 gamma2 = 1
